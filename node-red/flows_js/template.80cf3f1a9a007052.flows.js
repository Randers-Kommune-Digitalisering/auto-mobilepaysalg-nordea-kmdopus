...
function PublishWsMessage(m) { if (ws) { ws.send(m); } }
...
function generateRule(index) {
    const forretningsregel = activeRules[index];
    ...
    // Skal kun bruges i info WS
    // setSectionBackgroundColor(section, activeRules[index][6].active);
